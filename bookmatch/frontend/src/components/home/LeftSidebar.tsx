      ...
      <List sx={{ py: 0 }}>
        <ListItemButton
          ...
          sx={{
            ...
            background: 'linear-gradient(135deg, rgba(46, 111, 242, 0.1) 0%, rgba(83, 246, 130, 0.1) 100%)',
            '&:hover': {
              background: 'linear-gradient(135deg, rgba(46, 111, 242, 0.2) 0%, rgba(83, 246, 130, 0.2) 100%)',
            },
        ...
        >
          ...
          {!collapsed && (
            <ListItemText
              primary="Comprar Libros"
              secondary="Inicia TFT"
